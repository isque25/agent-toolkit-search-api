...
from agent_toolkit import AgentToolkit, AsyncAgentToolkit, APIResponseValidationError
from agent_toolkit._types import Omit
from agent_toolkit._utils import asyncify
...
def _get_open_connections(client: AgentToolkit | AsyncAgentToolkit) -> int:
...
class TestAgentToolkit:
    ...
    def test_raw_response(self, respx_mock: MockRouter, client: AgentToolkit) -> None:
    ...
    @pytest.mark.respx(base_url=base_url)
    def test_raw_response_for_binary(self, respx_mock: MockRouter, client: AgentToolkit) -> None:
    ...
    def test_copy(self, client: AgentToolkit) -> None:
        copied = client.copy()
    ...
    def test_copy_default_options(self, client: AgentToolkit) -> None:
    ...
    def test_copy_signature(self, client: AgentToolkit) -> None:
    ...
    def test_copy_build_request(self, client: AgentToolkit) -> None:
            ...
            for frame in diff.traceback:
                if any(
                    ...
                    for fragment in [
                        ...
                        "agent_toolkit/_legacy_response.py",
                        "agent_toolkit/_response.py",
                        # pydantic.BaseModel.model_dump || pydantic.BaseModel.dict leak memory for some reason.
                        "agent_toolkit/_compat.py",
    ...
    def test_request_timeout(self, client: AgentToolkit) -> None:
        request = client._build_request(FinalRequestOptions(method="get", url="/foo"))
    ...
    def test_hardcoded_query_params_in_url(self, client: AgentToolkit) -> None:
    ...
    def test_request_extra_json(self, client: AgentToolkit) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_request_extra_headers(self, client: AgentToolkit) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_request_extra_query(self, client: AgentToolkit) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_multipart_repeating_array(self, client: AgentToolkit) -> None:
        request = client._build_request(
    ...
    @pytest.mark.respx(base_url=base_url)
    def test_binary_content_upload(self, respx_mock: MockRouter, client: AgentToolkit) -> None:
    ...
    @pytest.mark.respx(base_url=base_url)
    def test_binary_content_upload_with_body_is_deprecated(self, respx_mock: MockRouter, client: AgentToolkit) -> None:
        respx_mock.post("/upload").mock(side_effect=mirror_request_content)
    ...
    @pytest.mark.respx(base_url=base_url)
    def test_basic_union_response(self, respx_mock: MockRouter, client: AgentToolkit) -> None:
    ...
    @pytest.mark.respx(base_url=base_url)
    def test_union_response_different_types(self, respx_mock: MockRouter, client: AgentToolkit) -> None:
    ...
    def test_non_application_json_content_type_for_json_data(
        self, respx_mock: MockRouter, client: AgentToolkit
    ) -> None:
        """
    ...
    def test_base_url_env(self) -> None:
        with update_env(AGENT_TOOLKIT_BASE_URL="http://localhost:5000/from/env"):
            client = AgentToolkit(api_key=api_key, _strict_response_validation=True)
    ...
    def test_base_url_trailing_slash(self, client: AgentToolkit) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_base_url_no_trailing_slash(self, client: AgentToolkit) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_absolute_request_url(self, client: AgentToolkit) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
    ...
    def test_copied_client_does_not_close_http(self) -> None:
        test_client = AgentToolkit(base_url=base_url, api_key=api_key, _strict_response_validation=True)
    ...
    @pytest.mark.respx(base_url=base_url)
    def test_client_response_validation_error(self, respx_mock: MockRouter, client: AgentToolkit) -> None:
        class Model(BaseModel):
            foo: str
    ...
    def test_received_text_for_expected_json(self, respx_mock: MockRouter) -> None:
        ...
        strict_client = AgentToolkit(base_url=base_url, api_key=api_key, _strict_response_validation=True)

        with pytest.raises(APIResponseValidationError):
            strict_client.get("/foo", cast_to=Model)

        non_strict_client = AgentToolkit(base_url=base_url, api_key=api_key, _strict_response_validation=False)
    ...
    def test_parse_retry_after_header(
        self, remaining_retries: int, retry_after: str, timeout: float, client: AgentToolkit
    ) -> None:
    ...
    @mock.patch("agent_toolkit._base_client.BaseClient._calculate_retry_timeout", _low_retry_timeout)
    @pytest.mark.respx(base_url=base_url)
    def test_retrying_timeout_errors_doesnt_leak(self, respx_mock: MockRouter, client: AgentToolkit) -> None:
        respx_mock.get("/api/v1/search").mock(side_effect=httpx.TimeoutException("Test timeout error"))

        with pytest.raises(APITimeoutError):
            client.api.v1.with_streaming_response.search(query="query").__enter__()

        assert _get_open_connections(client) == 0

    @mock.patch("agent_toolkit._base_client.BaseClient._calculate_retry_timeout", _low_retry_timeout)
    @pytest.mark.respx(base_url=base_url)
    def test_retrying_status_errors_doesnt_leak(self, respx_mock: MockRouter, client: AgentToolkit) -> None:
        respx_mock.get("/api/v1/search").mock(return_value=httpx.Response(500))
    ...
    def test_retries_taken(
        ...
        respx_mock.get("/api/v1/search").mock(side_effect=retry_handler)

        response = client.api.v1.with_raw_response.search(query="query")
    ...
    def test_omit_retry_count_header(
        self, client: AgentToolkit, failures_before_success: int, respx_mock: MockRouter
    ) -> None:
        client = client.with_options(max_retries=4)
    ...
    @pytest.mark.respx(base_url=base_url)
    def test_follow_redirects(self, respx_mock: MockRouter, client: AgentToolkit) -> None:
    ...
    @pytest.mark.respx(base_url=base_url)
    def test_follow_redirects_disabled(self, respx_mock: MockRouter, client: AgentToolkit) -> None:
...
class TestAsyncAgentToolkit:
    @pytest.mark.respx(base_url=base_url)
    async def test_raw_response(self, respx_mock: MockRouter, async_client: AsyncAgentToolkit) -> None:
        respx_mock.post("/foo").mock(return_value=httpx.Response(200, json={"foo": "bar"}))
    ...
    @pytest.mark.respx(base_url=base_url)
    async def test_raw_response_for_binary(self, respx_mock: MockRouter, async_client: AsyncAgentToolkit) -> None:
        respx_mock.post("/foo").mock(
            return_value=httpx.Response(200, headers={"Content-Type": "application/binary"}, content='{"foo": "bar"}')
        )
    ...
    def test_copy(self, async_client: AsyncAgentToolkit) -> None:
    ...
    def test_copy_default_options(self, async_client: AsyncAgentToolkit) -> None:
        # options that have a default are overridden correctly
    ...
    def test_copy_signature(self, async_client: AsyncAgentToolkit) -> None:
        # ensure the same parameters that can be passed to the client are defined in the `.copy()` method
        init_signature = inspect.signature(
            # mypy doesn't like that we access the `__init__` property.
    ...
    @pytest.mark.skipif(sys.version_info >= (3, 10), reason="fails because of a memory leak that started from 3.12")
    def test_copy_build_request(self, async_client: AsyncAgentToolkit) -> None:
        options = FinalRequestOptions(method="get", url="/foo")
    ...
    async def test_request_timeout(self, async_client: AsyncAgentToolkit) -> None:
    ...
    async def test_default_headers_option(self) -> None:
        ...
        test_client2 = AsyncAgentToolkit(
            base_url=base_url,
            api_key=api_key,
            _strict_response_validation=True,
            default_headers={
    ...
    async def test_hardcoded_query_params_in_url(self, async_client: AsyncAgentToolkit) -> None:
    ...
    def test_multipart_repeating_array(self, async_client: AsyncAgentToolkit) -> None:
        request = async_client._build_request(
            FinalRequestOptions.construct(
                method="post",
                url="/foo",
    ...
    @pytest.mark.respx(base_url=base_url)
    async def test_binary_content_upload(self, respx_mock: MockRouter, async_client: AsyncAgentToolkit) -> None:
        respx_mock.post("/upload").mock(side_effect=mirror_request_content)
    ...
    async def test_binary_content_upload_with_body_is_deprecated(
        self, respx_mock: MockRouter, async_client: AsyncAgentToolkit
    ) -> None:
        respx_mock.post("/upload").mock(side_effect=mirror_request_content)
    ...
    @pytest.mark.respx(base_url=base_url)
    async def test_basic_union_response(self, respx_mock: MockRouter, async_client: AsyncAgentToolkit) -> None:
        class Model1(BaseModel):
            name: str
    ...
    async def test_base_url_env(self) -> None:
        with update_env(AGENT_TOOLKIT_BASE_URL="http://localhost:5000/from/env"):
            client = AsyncAgentToolkit(api_key=api_key, _strict_response_validation=True)
            assert client.base_url == "http://localhost:5000/from/env/"
    ...
    async def test_base_url_trailing_slash(self, client: AsyncAgentToolkit) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    async def test_base_url_no_trailing_slash(self, client: AsyncAgentToolkit) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    async def test_absolute_request_url(self, client: AsyncAgentToolkit) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="https://myapi.com/foo",
    ...
    async def test_copied_client_does_not_close_http(self) -> None:
        test_client = AsyncAgentToolkit(base_url=base_url, api_key=api_key, _strict_response_validation=True)
        assert not test_client.is_closed()
    ...
    async def test_received_text_for_expected_json(self, respx_mock: MockRouter) -> None:
        ...
        strict_client = AsyncAgentToolkit(base_url=base_url, api_key=api_key, _strict_response_validation=True)

        with pytest.raises(APIResponseValidationError):
            await strict_client.get("/foo", cast_to=Model)

        non_strict_client = AsyncAgentToolkit(base_url=base_url, api_key=api_key, _strict_response_validation=False)
    ...
    async def test_parse_retry_after_header(
        self, remaining_retries: int, retry_after: str, timeout: float, async_client: AsyncAgentToolkit
    ) -> None:
        headers = httpx.Headers({"retry-after": retry_after})
        options = FinalRequestOptions(method="get", url="/foo", max_retries=3)
    ...
    async def test_retrying_timeout_errors_doesnt_leak(
        ...
        with pytest.raises(APITimeoutError):
            await async_client.api.v1.with_streaming_response.search(query="query").__aenter__()
    ...
    async def test_retries_taken(
        self,
        async_client: AsyncAgentToolkit,
        failures_before_success: int,
        failure_mode: Literal["status", "exception"],
        respx_mock: MockRouter,
    ) -> None:
        ...
        response = await client.api.v1.with_raw_response.search(query="query")
    ...
    async def test_omit_retry_count_header(
        self, async_client: AsyncAgentToolkit, failures_before_success: int, respx_mock: MockRouter
    ) -> None:
        client = async_client.with_options(max_retries=4)
        ...
        response = await client.api.v1.with_raw_response.search(
            query="query", extra_headers={"x-stainless-retry-count": Omit()}
        )
    ...
    @pytest.mark.respx(base_url=base_url)
    async def test_follow_redirects(self, respx_mock: MockRouter, async_client: AsyncAgentToolkit) -> None:
        # Test that the default follow_redirects=True allows following redirects
        respx_mock.post("/redirect").mock(
            return_value=httpx.Response(302, headers={"Location": f"{base_url}/redirected"})
        )
    ...
    @pytest.mark.respx(base_url=base_url)
    async def test_follow_redirects_disabled(self, respx_mock: MockRouter, async_client: AsyncAgentToolkit) -> None:
        # Test that follow_redirects=False prevents following redirects
        respx_mock.post("/redirect").mock(
            return_value=httpx.Response(302, headers={"Location": f"{base_url}/redirected"})
        )
